...
const MoreMenu = () => {
  ...
  const menuItems = [
    ...
    ...(user?.role === 'Admin' ? [{ title: t('userManagement'), icon: <Users size={20} />, link: '/users', color: '#8e44ad' }] : []),
    ...(user?.role === 'Admin' ? [{ title: t('systemLogs'), icon: <BookOpen size={20} />, link: '/logs', color: '#34495e' }] : []),
