      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '20px' }}>
        ...
        <div className="card" style={{ padding: '20px', height: 'fit-content' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '13px' }}>
            ...
            {profile.date_of_birth && <div style={{ display: 'flex', justifyContent: 'space-between' }}><span style={{ color: 'var(--text-light)' }}>Birthday:</span> <span style={{ fontWeight: '500', color: 'var(--text-main)' }}>{new Date(profile.date_of_birth).toLocaleDateString()}</span></div>}
